...
base_dir="/Volumes/Research_Data/Research_Datasets/Sperm/IVF_Data/Contamination_Analysis/"

# Path to beta values for your samples (Make sure it is a .csv file CG's are in the rows and sample names are in the columns)
betas="/Volumes/Research_Data/Research_Datasets/Sperm/IVF_Data/IVF_Data_beta_values.csv"
